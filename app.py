...
# polygon = Polygon(polygon_coordinates)
    ...
    if choose =="Dashboard":
        ...
        with col1:               # To display the header text using css style
            ...
            map = folium.Map(location=[22.78874298462253,72.75006444954514], zoom_start=11, scrollWheelZoom=True, tiles='Stamen Terrain')
    ...
    # Display the radio buttons with the custom CSS style
        ...
        if measure =="Temperature":
            ...
            df_temp = df_temp.loc[df_temp.loc[(df_temp['Vegetation encroachment'] == 'low') | (df_temp['Vegetation encroachment'] == 'Moderate') | (df_temp['Vegetation encroachment'] == 'high')]]
            df_temp["tuple"] = df_temp[["latitude","longitude"]].apply(tuple, axis=1)
            map = folium.Map(location=[22.606939204923812,74.11067787159304], zoom_start=11, scrollWheelZoom=True, tiles='Stamen Terrain')
